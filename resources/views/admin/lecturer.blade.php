...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="row mb-4">
        ...
        <div @if (count($dosen) == 0) hidden @endif class="col-6">
            <div class="d-flex flex-row-reverse">
                <div class="row">
                    <div class="col-auto">
                        {{-- <label for="cari" class="col-form-label">Cari Dosen</label> --}}
                      </div>
                      <div class="col-auto">
    ...
    {{-- <a href="/admin-area/dosen-pengajar/new" class="btn btn-primary btn-sm mb-4 mt-4">Data Baru</a> --}}
    <div class="row mb-5">
        @if (count($dosen) == 0) 
