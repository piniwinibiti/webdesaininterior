...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a href="/admin-area"
                ...
                Organisasi</a> / </span>Edit</h4>
    <div class="card">
        <h5 class="card-header">
            Edit Struktur Organisasi
        </h5>
        <form action="/admin-area/struktur-organisasi/edit/update" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="mb-3">
                    <label class="col-md-3 col-form-label">ID Organisasi</label>
                    <input class="form-control" type="text" name="organization_id" value="{{ $organization[0] -> id_struktur }}" readonly />
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <img src="{{ asset('img/organization/'.$organization[0] -> data_struktur) }}" alt="preview image" class="d-block rounded img-fluid" height="300" width="300"
                                id="uploadedAvatar" />
                        </div>
                    </div>
                </div>
