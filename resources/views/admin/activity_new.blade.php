...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="/admin-area" class="a-breadcrumbs">Beranda</a> / <a href="/admin-area/galeri"
            class="a-breadcrumbs">Informasi Umum</a> / Data Baru</h4>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <form action="/admin-area/agenda-kegiatan/submit" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="isi" id="summernote"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
