                ...
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="category_id" value="{{ $category[0] -> id_kategori }}"
                                    readonly />
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" type="text" name="category_name" value="{{ $category[0] -> nama_kategori }}" />
                            </div>
                        </div>
                    </div>
                </div>
