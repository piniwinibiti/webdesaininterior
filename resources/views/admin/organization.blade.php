            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-3 mb-3">
                    <div class="card h-100">
                        <img class="card-img-top" id="imgSrc" src="{{ asset('img/organization/'.$data->data_struktur) }}"
                            alt="Card image" />
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="text-end">
                                    ...
                                    <button
                                        onclick="if (confirm('Hapus data {{ $data -> id_struktur }}')) { location.replace('/admin-area/struktur-organisasi/delete/{{ Crypt::encrypt($data -> id_struktur) }}') }"
