...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><a href="/admin-area" class="a-breadcrumbs">Beranda</a> / <a href="/admin-area/prestasi-mahasiswa"
            class="a-breadcrumbs">Prestasi Mahasiswa</a> / Data Baru</h4>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <form action="/admin-area/prestasi-mahasiswa/submit" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        placeholder="Prestasi(juara 1/2/3)">    
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Tingkat</label>
                                        <input type="text" name="tingkat" class="form-control" required
                                        placeholder="Tingkat(Nasional/Lokal/Internasional)">    
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Nama Kegiatan</label>
                                        <textarea class="form-control" name="nama_kegiatan" id="summernote"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
